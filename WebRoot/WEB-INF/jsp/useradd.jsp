...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/sys/user/saveUser">
                ...
                <div>
                	<input type="hidden" id="errorfile" value="${uploadFileError}"/>
                    <label for="a_idPicPath">证件照：</label>
                    <input type="file" name="attachs" id="a_idPicPath"/> 
					<font color="red"></font>
                </div>
                <div>
                	<input type="hidden" id="errorWpfile" value="${uploadWpError}"/>
