...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/sys/user/userList">
					 <span>用户名：</span>
					 ...
					 <a href="${pageContext.request.contextPath}/sys/user/useradd" >添加用户</a>
				</form>
            </div>
            <!--用户-->
			...
			<input type="hidden" id="totalPageCount" value="${totalPageCount}"/>
          	...
          	<div class="providerAdd">
                ...
                <div>
                    ...
                    <input type="text" Class="Wdate" id="v_birthday" onclick="WdatePicker();" readonly="readonly">
					<font color="red"></font>
                </div>
                <div>
                    <label for="creationDate">创建日期：</label>
                    <input type="text" Class="Wdate" id="v_creationDate" onclick="WdatePicker();" readonly="readonly">
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    <label for="userCode">用户角色：</label>
                    <input type="text" id="v_userRoleName" value="" readonly="readonly"> 
					<font color="red"></font>
                </div>
                <div>
                    <label for="address">用户地址：</label>
                   <input name="address" id="v_address"  value="" readonly="readonly">
                </div>
        </div>
        </div>
    </section>
